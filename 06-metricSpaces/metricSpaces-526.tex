...
that is discussed in the appendix to the lecture notes on sets.
Essentially, the definition of the real numbers requires them to be
complete.
...
\begin{lemma}
  ...
  empty i.e. 
  $\cap_{\alpha \in \mathcal{A}} C_\alpha$ is not empty.
\end{lemma}
\begin{proof}
