...
\begin{align*}
  ...
  = & \int_0^T \frac{\partial F}{\partial x}(x(t),y(t),t) dt
\end{align*}
\footnote{The dominated convergence theorem gives conditions for which
  $\lim \int something = \int \lim something$. Here, an easy
  sufficient condition is existence $\frac{\partial F}{\partial x}$ and
