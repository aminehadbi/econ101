\message{ !name(lec09implicit.tex)}\documentclass[12pt,reqno]{amsart}
...
\begin{document}
\setcounter{section@level}{2}\setcounter{Hfootnote}{1}\setcounter{Item}{4}\setcounter{subsection}{2}\setcounter{section}{4}\setcounter{footnote}{1}\setcounter{enumi}{2}\setcounter{equation}{3}\setcounter{page}{4}
\message{ !name(lec09implicit.tex) !offset(516) }
\begin{align*}
...
\end{align*}
\message{ !name(lec09implicit.tex) !offset(518) }
