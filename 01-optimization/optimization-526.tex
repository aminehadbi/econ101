...
A related concept to the maximum is the supremum, or least upper
bound.
\begin{definition}
...
\begin{proof}
  ...
  % Add details ... seems like a distraction 
\end{proof}
...
To solve the first order conditions of an inequality constrained
...
We can also analyze how the maximizer varies with the parameters. We
...
Whether expressed using matrices or not, this system of equations is a
...
\begin{example}[Production theory]
