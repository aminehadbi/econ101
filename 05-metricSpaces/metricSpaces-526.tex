...
easier proofs and new insights. There also exist some reasonable
sets that can be assigned a topology, but for which there does not
...
closed sets are three different ways of describing notions of
...
\begin{remark}
  ...
  often in economics, but they do appear in econometrics. An example
